...
public class TeamCat extends TeamAnimal implements Jumpable, Summable {
    ...
    public TeamCat(String name, int run_limit, int swim_limit, float jump_limit){
        this.name = name;
        this.run_limit = run_limit;
